...
/** @var themes\clipone\views\Settings $this */
...
foreach ($this->getSettings() as $tuning) {
    ...
    echo '<li role="presentation" class="nav-item '.(0 == $index++ ? 'active' : '').'">
...
foreach ($this->getSettings() as $tuning) {
    ?>
				<div id="settings-<?php echo $tuning->getName(); ?>" role="tabpanel" class="tab-pane <?php echo 0 == $index++ ? 'active' : ''; ?>">
