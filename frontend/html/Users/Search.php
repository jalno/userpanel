...
<div class="row">
	<div class="col-lg-3 col-lg-offset-9 col-md-4 col-md-offset-8 col-sm-4 col-sm-offset-8">
		<a class="btn btn-info btn-block btn-export<?php echo !$hasUsers ? ' disabled' : ''; ?>" href="<?php echo $hasUsers ? url('users', array_merge($this->getFormData(), ['download' => 'csv'])) : '#'; ?>"<?php echo !$hasUsers ? ' disabled' : ''; ?>>
