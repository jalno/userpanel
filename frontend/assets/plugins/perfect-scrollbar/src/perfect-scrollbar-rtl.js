  ...
  $.fn.perfectScrollbar = function (suppliedSettings, option) {
    ...
    return this.each(function () {
      ...
      var $scrollbarXRail = $("<div class='ps-scrollbar-x-rail'></div>").appendTo($this),
          ...
          scrollbarYHeight,
          scrollbarYTop,
          scrollbarYLeft = parseInt($scrollbarYRail.css('right'), 10);
      ...
      var updateScrollbarCss = function () {
        ...
        $scrollbarYRail.css({top: $this.scrollTop(), left: scrollbarYLeft - $this.scrollLeft(), height: containerHeight, display: settings.suppressScrollY ? "none": "inherit"});
      ...
      var ieSupport = function (version) {
        ...
        var fixIe6ScrollbarPosition = function () {
          updateScrollbarCss = function () {
            ...
            $scrollbarY.css({top: scrollbarYTop + $this.scrollTop(), left: scrollbarYLeft, height: scrollbarYHeight});
