							...
							<tr>
								<td class="center">
									<div class="checkbox-table">
										<label>
											<input type="checkbox" class="flat-grey" name="permissions[]" value="<?php echo $permission;?>">
										</label>
									</div>
								</td>
							...
							?>
								<tr>
									<td class="center">
										<div class="checkbox-table">
											<label>
												<input type="checkbox" class="flat-grey" name="priorities[]" value="<?php echo $priority->id;?>">
											</label>
										</div>
									</td>
