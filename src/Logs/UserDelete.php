...
class UserDelete extends Logs
{
    ...
    public function buildFrontend(View $view)
    {
        ...
        $panel->size = 6;
        $panel->title = t('userpanel.user.logs.userDelete');
        $html = '<div class="form-group">';
        $html .= '<label class="col-xs-4 control-label">'.t('register.user.name').': </label>';
        $html .= '<div class="col-xs-8">'.$user->name.'</div>';
        $html .= '</div>';
        $html .= '<div class="form-group">';
        $html .= '<label class="col-xs-4 control-label">'.t('register.user.lastname').': </label>';
        $html .= '<div class="col-xs-8">'.$user->lastname.'</div>';
        $html .= '</div>';
        $html .= '<div class="form-group">';
        $html .= '<label class="col-xs-4 control-label">'.t('register.user.phone').': </label>';
        $html .= '<div class="col-xs-8 ltr">'.$user->phone.'</div>';
        $html .= '</div>';
        $html .= '<div class="form-group">';
        $html .= '<label class="col-xs-4 control-label">'.t('register.user.cellphone').': </label>';
        $html .= '<div class="col-xs-8 ltr">'.$user->cellphone.'</div>';
        $html .= '</div>';
        $html .= '<div class="form-group">';
        $html .= '<label class="col-xs-4 control-label">'.t('register.user.email').': </label>';
        $html .= '<div class="col-xs-8 ltr">'.$user->email.'</div>';
        $html .= '</div>';
        $html .= '<div class="form-group">';
        $html .= '<label class="col-xs-4 control-label">'.t('register.user.address').': </label>';
